# progammer_salary
Программа для вычисления средней зарплаты московских программистов по языку программирования. Используются данные [HeadHunter](https://hh.ru) за последний месяц и данные [Superjob](https://https://www.superjob.ru/). 
